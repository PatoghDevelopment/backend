...
from main_app.views import UserInfoApiView ,VerifyOTPView,ForgotPasswordView,ChangePasswordView,GatheringList
...
urlpatterns = [
    ...
    path('gathering/', GatheringList.as_view(), name='gathering_list'),

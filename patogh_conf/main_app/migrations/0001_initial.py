# Generated by Django 3.2.3 on 2022-04-03 14:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(blank=True, choices=[('ea', 'آذربایجان شرقی'), ('wa', 'آذربایجان غربی'), ('ardabil', 'اردبیل'), ('esfahan', 'اصفهان'), ('alborz', 'البرز'), ('ilam', 'ایلام'), ('bushehr', 'بوشهر'), ('tehran', 'تهران'), ('cha', 'چهارمحال و بختیاری'), ('khs', 'خراسان جنوبی'), ('khn', 'خراسان شمالی'), ('khr', 'خراسان رضوی'), ('khuzestan', 'خوزستان'), ('zanjan', 'زنجان'), ('semnan', 'سمنان'), ('sistan', 'سیستان و بلوچستان'), ('fars', 'فارس'), ('qazvin', 'قزوین'), ('qom', 'قم'), ('kordestan', 'کردستان'), ('kerman', 'کرمان'), ('kermanshah', 'کرمانشاه'), ('koh', 'کهگیلویه و بویر احمد'), ('golestan', 'گلستان'), ('gilan', 'گیلان'), ('lorestan', 'لرستان'), ('mazandaran', 'مازندران'), ('markazi', 'مرکزی'), ('hormozgan', 'هرمزگان'), ('hamedan', 'همدان'), ('yazd', 'یزد')], max_length=20, null=True, verbose_name='استان')),
                ('gender', models.CharField(blank=True, choices=[('f', 'female'), ('m', 'male'), ('o', 'other')], max_length=6, null=True, verbose_name='جنسیت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(choices=[('ea', 'آذربایجان شرقی'), ('wa', 'آذربایجان غربی'), ('ardabil', 'اردبیل'), ('esfahan', 'اصفهان'), ('alborz', 'البرز'), ('ilam', 'ایلام'), ('bushehr', 'بوشهر'), ('tehran', 'تهران'), ('cha', 'چهارمحال و بختیاری'), ('khs', 'خراسان جنوبی'), ('khn', 'خراسان شمالی'), ('khr', 'خراسان رضوی'), ('khuzestan', 'خوزستان'), ('zanjan', 'زنجان'), ('semnan', 'سمنان'), ('sistan', 'سیستان و بلوچستان'), ('fars', 'فارس'), ('qazvin', 'قزوین'), ('qom', 'قم'), ('kordestan', 'کردستان'), ('kerman', 'کرمان'), ('kermanshah', 'کرمانشاه'), ('koh', 'کهگیلویه و بویر احمد'), ('golestan', 'گلستان'), ('gilan', 'گیلان'), ('lorestan', 'لرستان'), ('mazandaran', 'مازندران'), ('markazi', 'مرکزی'), ('hormozgan', 'هرمزگان'), ('hamedan', 'همدان'), ('yazd', 'یزد')], max_length=20, verbose_name='استان')),

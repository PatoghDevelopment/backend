# Generated by Django 3.2.3 on 2021-11-03 19:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PendingVerify',
            fields=[
                ('email', models.EmailField(max_length=50, primary_key=True, serialize=False, verbose_name='ایمیل کاربر')),
                ('otp', models.CharField(max_length=6, verbose_name='OTP کد')),
                ('send_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='زمان ارسال')),
                ('allowed_try_count', models.SmallIntegerField(default=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name=' دفعات مجاز برای تلاش')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('g_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main_app.patogh', verbose_name='کاربر')),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_state', models.CharField(blank=True, choices=[('0', 'registered'), ('1', 'verified'), ('-1', 'unverified')], default='-1', max_length=3, null=True, verbose_name='وضعیت احراض هویت')),
            ],
            options={
                'verbose_name': 'کاربر',

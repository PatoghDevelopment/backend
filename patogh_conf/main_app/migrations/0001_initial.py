# Generated by Django 3.2.3 on 2021-07-15 12:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('0', 'female'), ('1', 'male')], default='0', max_length=6, null=True, verbose_name='جنسیت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='شناسه پدید آورنده')),
                ('location_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main_app.locationtypes', verbose_name='مکان')),
            ],
            options={
                'verbose_name': 'پاتوق',

# Generated by Django 3.2.3 on 2021-07-13 18:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_telephone_verified', models.CharField(choices=[('0', 'registered'), ('1', 'verified')], max_length=10, verbose_name='صحت شماره تلفن')),
                ...
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='main_app.city', verbose_name='شهر')),
            ],
            options={
                'verbose_name': 'پاتوق',
        ...
        migrations.CreateModel(
            name='PendingVerify',
            fields=[
                ('receptor', models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='دریافت کننده')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('0', 'female'), ('1', 'male')], max_length=6, verbose_name='جنسیت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='main_app.users', verbose_name='فرستنده')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='patogh',
            name='creator_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.users', verbose_name='شناسه پدید آورنده'),
        ),
        migrations.AddField(
            model_name='patogh',
            name='location_type',
        ...
        migrations.AddField(
            model_name='patogh',
            name='tags_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.tags', verbose_name='شناسه برچست'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='creator_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='main_app.users', verbose_name='شناسه پدید آورنده'),
        ),
        migrations.AddField(
            model_name='gathering',
            name='patogh_id',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.users', verbose_name='نام کاربری')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='main_app.users', verbose_name='نام کاربری')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.ForeignKey(max_length=30, on_delete=django.db.models.deletion.CASCADE, to='main_app.users', verbose_name='نام کاربری')),
            ],
            options={

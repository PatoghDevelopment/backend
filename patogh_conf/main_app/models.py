...
class User(AbstractUser):
    ...
    email = models.CharField(verbose_name=_("ایمیل"),unique=True, max_length=50)
    ...
    profile_image_url = models.CharField(verbose_name=_("عکس پروفایل"),max_length=128,null = True , blank = True)
    bio = models.CharField(verbose_name=_("درباره"),max_length=1000,null = True , blank = True)
    last_login_try = models.TimeField(verbose_name=_("آخرین بازدید"),null = True , blank = True) 
...
class PatoghHaveImages(models.Model):
    ...
    image_url = models.CharField(verbose_name=_("عکسی برای دورهمی"),max_length=128)
    state = (
        ('0','registered'),
        ('1','accepted'),
        ('2','rejected'),
